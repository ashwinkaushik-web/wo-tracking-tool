...
# ============================================================
# Config lives entirely in st.secrets — nothing sensitive in code. Expected shape:
#
#   [slack]
#   bot_token    = "xoxb-..."          # bot token with chat:write (+ im:write for DMs)
...
# "not configured yet" note instead of erroring. See SLACK_MESSAGING_SETUP.md.
...
def _slack_dialog():
    ...
    if cfg is None:
        st.info(
            ...
            "See **SLACK_MESSAGING_SETUP.md** in the repo for the exact steps."
        )
        return
